...
function loadParagraph() 
{
    ...
    const chars = paragraphs[randPara].split("");
    const spanElements = chars.map(char => { return `<span>${char}</span>`; });
    typingText.innerHTML = spanElements.join("");
...
function Typing()
{
    ...
    const typedChar = inputText.value[currentindex];
